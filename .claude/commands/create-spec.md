...
4. `branch_name` — format: `feat/<feature_slug>`
   - Example: `feat/registration`
...
If `branch_name` is already taken, append a number: `feat/registration-01`, `feat/registration-02` etc.
